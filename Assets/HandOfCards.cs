...
public class HandOfCards {
    ...
    public Vector3 Center = new Vector3(0, 2.5f, -58); // center position of the hand
    public float ShownRadius = 22.0f; // radius when cards are visible
    public float HiddenRadius = 20.0f; // radius when cards are hidden
    public float CardSpacing = 6.66f; // base distance between cards
    ...
    public void UpdateHandDisplay() {
        ...
        for (int i = 0; i < cardCount; i++) {
            ...
            float baseAngleOffset = (i - midIndex) * RadialAngle - RadialAngle/2.0f;
